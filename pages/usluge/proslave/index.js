...
import banquetHall from "../../../public/images/celebrations/banquet-hall-black-medium.jpg";
import banquetHall1 from "../../../public/images/celebrations/banquet-hall-5-medium.jpg";
import banquetHall2 from "../../../public/images/celebrations/banquet-hall-1-medium.jpg";
import banquetHall3 from "../../../public/images/celebrations/banquet-hall-3-medium.jpg";
import banquetHall4 from "../../../public/images/celebrations/banquet-hall-black-3.jpg";
  ...
  return (
    <>
      ...
      <PageLayout
        ...
        pageLayoutSummary={t.common.markYourImportantDay}
        backgroundImageUrl={banquetHall4}
      >
        <article className="pagecelebrations">
          <h2 className="heading-secondary">
            {t.common.celebrationsFromDreams}
          </h2>
          ...
          <section className="pagecelebrations__hall">
            ...
            <div className="pagecelebrations__images">
              ...
              <Image src={banquetHall4} alt="banket sala hotela Svetionik" />
            </div>
          </section>
          <section className="pagecelebrations__hall">
            <div className="pagecelebrations__images">
